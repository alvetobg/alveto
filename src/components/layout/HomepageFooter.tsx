...
type HomepageFooterProps = Readonly<{
                ...
                {primaryLinks.map((link) => (
                  <li key={`${link.label}-${link.url}`}>
                    <a
                      ...
                      className="transition-colors duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-primary"
                    >
                      {link.label}
                    </a>
                  </li>
          ...
          {email || (phoneNumber && phoneHref) ? (
            <FooterGroup title="Contact">
              {email ? (
                <a
                  href={`mailto:${email}`}
                  className="block transition-colors duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-primary"
                >
                  {email}
                </a>
              ) : null}
              {phoneNumber && phoneHref ? (
                <a
                  href={phoneHref}
                  className="mt-1 block transition-colors duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-primary"
                >
                  {phoneNumber}
                </a>
              ) : null}
